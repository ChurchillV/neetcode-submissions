class Twitter {
    ...
    public List<Integer> getNewsFeed(int userId) {
        ...
        for(int followee : users.getOrDefault(userId, new TreeSet<>())) {
    ...
    public void follow(int followerId, int followeeId) {
        ...
        users.computeIfAbsent(followerId, f -> new TreeSet()).add(followeeId);
    }
    ...
    public void unfollow(int followerId, int followeeId) {
        ...
        users.computeIfAbsent(followerId, f -> new TreeSet()).remove(followeeId);
    }
}
